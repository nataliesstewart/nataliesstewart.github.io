...
> **Proposition 7.** Suppose $$\abs{w} \geq 3$$. Then, $$w$$ has a fully toroidal quotient of size at least 3 if and only if it is toroidally connected.
...
The wording of Proposition 7 is a bit weird;
...
> **Proposition 8.** Suppose $$w$$ is a fully toroidal weaves. Then $$w$$ is equivalent to either Möbius $$n$$ or $$n \cdot O$$.
...
by Lemma 9, every fully toroidal weave must then be generated under only kinging or only Möbiusing 
Then, Proposition 8 follows by noting that every $$n$$-component weave generated by kinging is $$n \cdot O$$ and every $$n$$-component weave generated by Möbiusing is $$M_n$$.
