...
### Prime weaves and $$\EE_3$$-primary decomposition
...
The reason this is useful for classification is the following claim:
...
Our first reduction, this time to the classification problem, will be the construction of nontrivial graded spaces $$\cA_*$$ and $$\cT_*$$, together with proving that
  <p align="center">
    $$\cW_* \simeq \cA_* \otimes \Fr_3\prn{\cT_{*+1}},$$
  </p>
